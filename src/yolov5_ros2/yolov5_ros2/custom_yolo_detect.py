...
class YoloV5Ros2(Node):
    ...
    def image_callback(self, msg: Image):
        ...
        for index in range(len(categories)):
            ...
            # Draw results. ### make sure to disable show_result and pub_result_img to skip this
        ...
        if len(categories) > 0:
            self.yolo_result_pub.publish(self.result_msg) ### check if any node depends on this
